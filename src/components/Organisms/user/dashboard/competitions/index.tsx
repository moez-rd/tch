 ...
 * @returns
 */
export default function DashboardCompetitions(props: Props) {
  // eslint-disable-next-line no-empty-pattern
  const { registrations } = props;

  return (
    <Container small>
      <SectionHeader secondary position="center" title="Kompetisi" />
        ...
        {registrations.length !== 0 ? (
          ...
          <Flex align="center" justify="center" mih="8rem">
            <Stack spacing="xs" align="center">
              <Paragraph color="gray.6">Tidak ada kompetisi</Paragraph>
              <Text color="gray.5" size="sm">
                Kompetisi yang Anda ikuti akan tampil di sini
              </Text>
            </Stack>
          </Flex>
        )}
