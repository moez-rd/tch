...
export const Head = ({ title, description, keywords, author, ogTitle, ogDescription, ogUrl, ogImage }: Props) => (
  <NextHead>
    <title>{title}</title>
...
Head.defaultProps = {
  ...
  keywords: 'next, starter, typescript, styled components, prettier, eslint, husky, seo',
  ogDescription:
    'A highly opinionated and complete starter for Next.js projects ready to production. Includes Typescript, Styled Components, Prettier, ESLint, Husky, SEO, and more.',
